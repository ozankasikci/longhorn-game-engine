        ...
        egui::SidePanel::right("asset_browser")
            ...
            .show(ctx, |ui| {
                ...
                ScrollArea::vertical().show(ui, |ui| {
                    let filtered_assets: Vec<_> = state.assets.values()
                        .filter(|asset| {
                            state.search_query.is_empty() || 
                            asset.name.to_lowercase().contains(&state.search_query.to_lowercase())
                        })
                    ...
                    if self.show_thumbnails {
                        ...
                        let items_per_row = (ui.available_width() / (self.thumbnail_size + 10.0)) as usize;
                        ...
                        egui::Grid::new("asset_grid")
                            ...
                            .show(ui, |ui| {
                                for (i, asset) in filtered_assets.iter().enumerate() {
                                    ...
                                    ui.allocate_ui(egui::vec2(self.thumbnail_size, self.thumbnail_size + 20.0), |ui| {
