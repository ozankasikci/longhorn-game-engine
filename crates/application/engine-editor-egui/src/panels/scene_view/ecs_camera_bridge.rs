...
use engine_components_3d::{Camera, Transform, MainCamera};
use engine_camera_impl::{FPSCameraController, CameraController, CameraInput};
...
impl EditorCameraManager {
    ...
    pub fn handle_input(
        ...
        if let Some(entity) = self.camera_entity {
            ...
            let mut transform = world.get_component::<Transform>(entity)
                .cloned()
                .unwrap_or_default();
            ...
            self.fps_controller.update(&mut transform, &camera_input, delta_time);
