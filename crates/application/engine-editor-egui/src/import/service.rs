...
use super::{ImportSettings, CollisionType};
use super::wrappers::{ObjImporterWrapper, StandardTextureImporterWrapper, StandardAudioImporterWrapper};
use uuid::Uuid;
...
impl ImportService {
    ...
    pub fn register_mesh_importers(&mut self) {
        ...
        self.pipeline.register_importer(Box::new(ObjImporterWrapper::create()));
