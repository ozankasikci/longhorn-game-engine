...
impl SettingsDialog {
    ...
    fn show_camera_settings(&mut self, ui: &mut egui::Ui) {
        ...
        egui::Grid::new("camera_settings_grid")
            ...
            .show(ui, |ui| {
                ...
                ui.add(egui::Slider::new(&mut self.temp_settings.camera.movement_speed, 0.5..=20.0)
                    .suffix(" units/sec"));
                ui.end_row();
                
                // Fast movement multiplier
                ui.label("Sprint Multiplier:");
                ui.add(egui::Slider::new(&mut self.temp_settings.camera.fast_multiplier, 1.5..=10.0)
                    .suffix("x"));
                ui.end_row();
                
                // Rotation sensitivity
                ui.label("Look Sensitivity:");
                ui.add(egui::Slider::new(&mut self.temp_settings.camera.rotation_sensitivity, 0.001..=0.02)
                    .suffix(" rad/px")
    ...
    fn show_grid_settings(&mut self, ui: &mut egui::Ui) {
        ...
        egui::Grid::new("grid_settings_grid")
            ...
            .show(ui, |ui| {
                ...
                ui.label("Grid Size:");
                ui.add(egui::Slider::new(&mut self.temp_settings.grid.size, 0.1..=10.0)
                    .suffix(" units"));
                ui.end_row();
                
                ui.label("Subdivisions:");
                ui.add(egui::Slider::new(&mut self.temp_settings.grid.subdivisions, 1..=20));
                ui.end_row();
            });
    }
    ...
    fn show_snap_settings(&mut self, ui: &mut egui::Ui) {
        ...
        egui::Grid::new("snap_settings_grid")
            ...
            .show(ui, |ui| {
                ...
                ui.add(egui::Slider::new(&mut self.temp_settings.snap.position_increment, 0.01..=2.0)
                    .suffix(" units"));
                ui.end_row();
                
                ui.label("Rotation Snap:");
                ui.add(egui::Slider::new(&mut self.temp_settings.snap.rotation_increment, 1.0..=90.0)
                    .suffix("°"));
                ui.end_row();
                
                ui.label("Scale Snap:");
                ui.add(egui::Slider::new(&mut self.temp_settings.snap.scale_increment, 0.01..=1.0));
                ui.end_row();
            });
    }
    ...
    fn show_theme_settings(&mut self, ui: &mut egui::Ui) {
        ...
        egui::Grid::new("theme_settings_grid")
            ...
            .show(ui, |ui| {
                ui.label("UI Scale:");
                ui.add(egui::Slider::new(&mut self.temp_settings.theme.ui_scale, 0.5..=2.0)
                    .suffix("x"));
                ui.end_row();
                
                ui.label("Font Size:");
                ui.add(egui::Slider::new(&mut self.temp_settings.theme.font_size, 8.0..=20.0)
                    .suffix(" pt"));
                ui.end_row();
            });
    }
