...
fn test_scene_view_integration() {
    ...
    use engine_editor_scene_view::{SceneView, types::{SceneNavigation, PlayState}};
    ...
    assert_eq!(scene_nav.current_tool, engine_editor_scene_view::types::SceneTool::Select);
}
...
fn test_ui_components() {
    ...
    use engine_editor_ui::{Toolbar, MenuBar, SettingsDialog, EditorSettings};
...
fn test_asset_management() {
    ...
    use engine_editor_assets::{TextureManager, AssetCache, create_default_textures};
...
fn test_framework_state_management() {
    ...
    use engine_editor_framework::{EditorState, EditorCoordinator, PlayState};
...
fn test_console_message_flow() {
    ...
    use engine_editor_panels::{ConsolePanel, ConsoleMessage as PanelMessage};
