...
mod cube_rendering_tests {
    ...
    use engine_components_3d::{Transform, Mesh, MeshType, Material, Visibility};
    ...
    fn test_cube_entity_visibility_query() {
        ...
        world.add_component(cube_entity, Mesh { mesh_type: MeshType::Cube }).unwrap();
        ...
        let entities_with_meshes: Vec<_> = world.query_legacy::<Transform>()
    ...
    fn collect_renderable_entities(world: &World, camera_entity: engine_ecs_core::Entity) -> Vec<engine_ecs_core::Entity> {
