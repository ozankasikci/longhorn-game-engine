...
impl Default for ShortcutManager {
    fn default() -> Self {
        ...
        // Standard shortcuts
        shortcuts.insert(ShortcutAction::Undo, KeyboardShortcut::new(
            egui::Key::Z,
            egui::Modifiers::COMMAND,
        ));
        
        shortcuts.insert(ShortcutAction::Redo, KeyboardShortcut::new(
            egui::Key::Z,
            egui::Modifiers::COMMAND | egui::Modifiers::SHIFT,
        ));
        
        shortcuts.insert(ShortcutAction::Delete, KeyboardShortcut::new(
            egui::Key::Delete,
            egui::Modifiers::NONE,
        ));
        
        shortcuts.insert(ShortcutAction::Rename, KeyboardShortcut::new(
            egui::Key::F2,
            egui::Modifiers::NONE,
        ));
        
        shortcuts.insert(ShortcutAction::Copy, KeyboardShortcut::new(
            egui::Key::C,
            egui::Modifiers::COMMAND,
        ));
        
        shortcuts.insert(ShortcutAction::Paste, KeyboardShortcut::new(
            egui::Key::V,
            egui::Modifiers::COMMAND,
        ));
        
        shortcuts.insert(ShortcutAction::Cut, KeyboardShortcut::new(
            egui::Key::X,
            egui::Modifiers::COMMAND,
        ));
        
        shortcuts.insert(ShortcutAction::SelectAll, KeyboardShortcut::new(
            egui::Key::A,
            egui::Modifiers::COMMAND,
        ));
        
        shortcuts.insert(ShortcutAction::Search, KeyboardShortcut::new(
            egui::Key::F,
            egui::Modifiers::COMMAND,
        ));
        
        shortcuts.insert(ShortcutAction::NewFolder, KeyboardShortcut::new(
            egui::Key::N,
            egui::Modifiers::COMMAND | egui::Modifiers::SHIFT,
        ));
        
        shortcuts.insert(ShortcutAction::Refresh, KeyboardShortcut::new(
            egui::Key::F5,
            egui::Modifiers::NONE,
        ));
...
mod tests {
    ...
    fn test_format_shortcut() {
        ...
        if cfg!(target_os = "macos") {
            ...
            assert_eq!(manager.format_shortcut(ShortcutAction::Redo), "Ctrl+Shift+Z");
        }
    ...
    fn test_undo_redo_shortcuts() {
        ...
        let redo_shortcut = KeyboardShortcut::new(egui::Key::Z, egui::Modifiers::COMMAND | egui::Modifiers::SHIFT);
        ...
        let redo_input = create_test_input(egui::Key::Z, egui::Modifiers::COMMAND | egui::Modifiers::SHIFT);
