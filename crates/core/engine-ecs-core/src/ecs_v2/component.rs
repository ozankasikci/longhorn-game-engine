...
mod tests {
    ...
    fn test_component_registration() {
        ...
        #[derive(Clone, Debug, PartialEq)]
        struct UniqueTestComponent { value: i32 }
    ...
    fn test_component_array_trait_object() {
        ...
        // Test downcasting
        let downcast = trait_obj.as_any().downcast_ref::<ComponentArray<TestComponent>>();
    ...
    fn test_push_cloned_wrong_type() {
        let mut array = ComponentArray::<TestComponent>::new();
        let wrong_component = AnotherComponent { data: "wrong".to_string() };
        let tick = ComponentTicks::new(Tick::new(1));
