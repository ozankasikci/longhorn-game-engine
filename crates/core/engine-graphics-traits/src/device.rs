use crate::{
    AddressMode, BindGroupDescriptor, BindGroupLayoutDescriptor, BufferDescriptor, FilterMode,
    GraphicsBindGroup, GraphicsBindGroupLayout, GraphicsBuffer, GraphicsCommandEncoder,
    GraphicsSampler, GraphicsTexture, GraphicsTextureView, Result, TextureDescriptor,
};
...
mod tests {
    ...
    use crate::{
        ...
        BufferUsage, Extent3d, GraphicsError, ShaderStages, TextureFormat, TextureSampleType,
    ...
    impl GraphicsCommandEncoder for MockCommandEncoder {
        ...
        fn begin_render_pass<'a>(
            &'a mut self,
            _desc: &crate::RenderPassDescriptor<'a>,
        ) -> Self::RenderPass<'a> {
            MockRenderPass {
    ...
    impl GraphicsDevice for MockDevice {
        ...
        fn create_sampler(&self, desc: &SamplerDescriptor) -> Result<Self::Sampler> {
            Ok(MockSampler { desc: desc.clone() })
        }
