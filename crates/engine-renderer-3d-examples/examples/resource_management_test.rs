...
use engine_renderer_3d::{Camera, Material, Mesh, RenderObject, RenderScene, Renderer3D};
use glam::{Mat4, Vec3};
use std::sync::Arc;
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let mut updated_gold =
        Material::with_color("Gold Updated".to_string(), Vec3::new(1.0, 0.9, 0.2));
