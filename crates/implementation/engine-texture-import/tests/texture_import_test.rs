...
use engine_texture_import::{
    TextureImporter, TextureData, TextureFormat, TextureSettings,
    TextureError
};
...
fn test_texture_settings() {
    ...
    assert_eq!(settings.compression, engine_texture_import::CompressionType::None);
    assert_eq!(settings.filter_mode, engine_texture_import::FilterMode::Linear);
...
fn test_dds_import() {
    ...
    dds_data.extend(vec![       // Pixel format
        32, 0, 0, 0,             // Size
...
fn test_texture_compression() {
    ...
    use engine_texture_import::compression::{TextureCompressor, CompressionOptions};
...
fn test_texture_resize() {
    ...
    use engine_texture_import::processing::{TextureResizer, ResizeOptions};
...
fn test_normal_map_processing() {
    ...
    use engine_texture_import::processing::{NormalMapProcessor, NormalMapOptions};
