use crate::{TextureData, TextureFormat, TextureError, CompressionType};
...
impl TextureCompressor {
    ...
    pub fn compress(&self, texture: &TextureData, options: &CompressionOptions) -> Result<TextureData, TextureError> {
