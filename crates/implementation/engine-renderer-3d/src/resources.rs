...
impl ResourceManager {
    ...
    pub fn upload_material(
        ...
        self.materials
            .write()
            .unwrap()
            .insert(material_id, material_resource);
    ...
    pub fn get_material(
        &self,
        material_id: u32,
    ) -> Option<std::sync::RwLockReadGuard<HashMap<u32, MaterialResource>>> {
    ...
    pub fn get_texture(
        ...
        std::sync::RwLockReadGuard<std::collections::HashMap<u32, crate::texture::TextureResource>>,
    > {
