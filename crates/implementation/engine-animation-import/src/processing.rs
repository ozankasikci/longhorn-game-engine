use crate::{AnimationData, Channel, Keyframe, InterpolationType, AnimationError};
...
impl KeyframeOptimizer {
    ...
    fn is_redundant(&self, prev: &Keyframe, curr: &Keyframe, next: &Keyframe, tolerance: f32) -> bool {
...
impl FpsConverter {
    ...
    pub fn convert(&self, _animation: &mut AnimationData, source_fps: f32, target_fps: f32) -> Result<(), AnimationError> {
