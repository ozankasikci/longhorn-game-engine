...
impl MeshPrimitives {
    ...
    pub fn cube(size: f32) -> Mesh {
        ...
        Mesh::from_data(MeshData::new("Cube".to_string(), vertices, indices))
    }
    ...
    pub fn quad() -> Mesh {
        ...
        Mesh::from_data(MeshData::new("Quad".to_string(), vertices, indices))
    }
    ...
    pub fn sphere(radius: f32, rings: u32, sectors: u32) -> Mesh {
        ...
        Mesh::from_data(MeshData::new("Sphere".to_string(), vertices, indices))
    }
    ...
    pub fn cylinder(top_radius: f32, bottom_radius: f32, height: f32, sectors: u32) -> Mesh {
        ...
        Mesh::from_data(MeshData::new("Cylinder".to_string(), vertices, indices))
    }
    ...
    pub fn plane(width: f32, height: f32, subdivisions_x: u32, subdivisions_y: u32) -> Mesh {
        ...
        for y in 0..=subdivisions_y {
            for x in 0..=subdivisions_x {
                ...
                let position = Vec3::new((u - 0.5) * width, 0.0, (v - 0.5) * height);
        ...
        Mesh::from_data(MeshData::new("Plane".to_string(), vertices, indices))
    }
    ...
    pub fn triangle() -> Mesh {
        ...
        Mesh::from_data(MeshData::new("Triangle".to_string(), vertices, indices))
    }
    ...
    pub fn cone(radius: f32, height: f32, sectors: u32) -> Mesh {
        ...
        // Tip vertex
        vertices.push(
            Vertex::new(Vec3::new(0.0, half_height, 0.0))
                .with_normal(Vec3::Y)
                .with_uv(Vec2::new(0.5, 1.0)),
        );
        ...
        Mesh::from_data(MeshData::new("Cone".to_string(), vertices, indices))
    }
...
impl PrimitiveGenerator for DefaultPrimitiveGenerator {
    fn generate(&self, params: &PrimitiveParams) -> engine_geometry_core::Result<Mesh> {
        let mesh = match params {
            ...
            PrimitiveParams::Sphere(params) => {
                MeshPrimitives::sphere(params.radius, params.rings, params.sectors)
            }
            PrimitiveParams::Cylinder(params) => MeshPrimitives::cylinder(
                params.top_radius,
                params.bottom_radius,
                params.height,
                params.sectors,
            ),
            PrimitiveParams::Cone(params) => {
                MeshPrimitives::cone(params.radius, params.height, params.sectors)
            }
            PrimitiveParams::Plane(params) => MeshPrimitives::plane(
                params.width,
                params.height,
                params.subdivisions_x,
                params.subdivisions_y,
            ),
            PrimitiveParams::Quad => MeshPrimitives::quad(),
            PrimitiveParams::Triangle => MeshPrimitives::triangle(),
            PrimitiveParams::Capsule(params) => MeshPrimitives::cylinder(
                params.top_radius,
                params.bottom_radius,
                params.height,
                params.sectors,
            ),
            PrimitiveParams::Torus(params) => {
                MeshPrimitives::sphere(params.radius, params.rings, params.sectors)
            }
        };
        Ok(mesh)
...
impl PrimitiveMeshFactory for DefaultPrimitiveGenerator {
    ...
    fn cylinder(
        ...
        height: f32,
        sectors: u32,
    ) -> engine_geometry_core::Result<Mesh> {
        Ok(MeshPrimitives::cylinder(
            top_radius,
            bottom_radius,
            height,
            sectors,
