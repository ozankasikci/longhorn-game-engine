...
fn test_mesh_data_structure() {
    ...
    use engine_mesh_import::{MeshData, Vertex, Material};
...
async fn test_obj_importer() {
    ...
    use engine_asset_import::{ImportContext, ImportSettings, AssetImporter};
...
fn test_mesh_validation() {
    ...
    use engine_mesh_import::{MeshValidator, MeshData, Vertex, ValidationError};
...
fn test_mesh_optimization() {
    ...
    use engine_mesh_import::{MeshOptimizer, MeshData, Vertex};
...
fn test_normal_generation() {
    ...
    use engine_mesh_import::{NormalGenerator, MeshData, Vertex};
    ...
    let mut mesh_data = MeshData {
        ...
        vertices: vec![
            ...
            Vertex { position: [0.5, 1.0, 0.0], normal: [0.0, 0.0, 0.0], ..Default::default() },
        ],
        indices: vec![0, 1, 2],
        material: None,
    };
...
fn test_mesh_bounds_calculation() {
    ...
    use engine_mesh_import::{MeshData, Vertex, calculate_bounds};
    ...
    let mesh_data = MeshData {
        ...
        vertices: vec![
            ...
            Vertex { position: [1.0, 1.0, 1.0], ..Default::default() },
            Vertex { position: [0.0, 2.0, -2.0], ..Default::default() },
        ],
        indices: vec![0, 1, 2],
        material: None,
    };
