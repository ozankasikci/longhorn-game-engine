...
impl MeshRepairer {
    ...
    pub fn repair(&self, mut mesh: MeshData, options: &RepairOptions) -> Result<MeshData, String> {
    ...
    fn remove_duplicates(&self, mesh: MeshData, threshold: f32) -> Result<MeshData, String> {
