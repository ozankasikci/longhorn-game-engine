...
impl MeshImportRegistry {
    pub fn new() -> Self {
        ...
        registry.importers.insert("obj".to_string(), ImporterType::Obj(crate::ObjImporter::new()));
        registry.importers.insert("gltf".to_string(), ImporterType::Gltf(crate::GltfImporter::new()));
        registry.importers.insert("glb".to_string(), ImporterType::Gltf(crate::GltfImporter::new()));
        registry.importers.insert("fbx".to_string(), ImporterType::Fbx(crate::FbxImporter::new()));
        
        registry
    }
    
    pub fn get_importer(&self, extension: &str) -> Option<&dyn AssetImporter<Asset = crate::MeshData>> {
        self.importers.get(&extension.to_lowercase())
