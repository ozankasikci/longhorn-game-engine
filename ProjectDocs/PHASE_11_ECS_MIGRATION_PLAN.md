...
Implement proper component migration in the ECS v2 system to enable dynamic component addition and removal at runtime. This will transform our static bundle-based ECS into a fully dynamic system like Unity/Godot.
